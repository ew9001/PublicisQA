...
public class MacFirefoxDesktopPreferenceCenter  {
	...
	public void beforeMethod01() {
		...
		System.out.println("Test 1 I want to test using browser Firefox ");
	...
	@Test(priority=2)
	public  void testBlankLogin02() throws IOException {
	...
	@Test(priority=3)
	 public void testWrongLogin03() throws IOException {
